                    ...
                    <div class="col-12">
                        <div class="p-3">
                            <div class="text-center">
                                <h1 id="title" class="h4 mb-2 font-weight-bold">Reset Your Password.</h1>
                            </div>
                            ...
                            <form action="{{ route('pwd_reset') }}" method="POST" autocomplete="off" class="mt-3">
                                @csrf
                                ...
                                <div class="row p-0">
                                    ...
                                    @error('user')
                                        <div class="col-md-8 offset-md-2">
                                            <div class="text-center"> <small class="text-danger">{{ $message }}</small>
                                            </div>
                                        </div>
                                    @enderror
