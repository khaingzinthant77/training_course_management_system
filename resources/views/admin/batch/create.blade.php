...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4 p-5">
            ...
            {{-- Create  --}}
            <div>
                <h1 class="h4 text-gray-900 mb-4">Batch Create</h1>
            </div>
            <form action="{{ route('batch.store') }}" method="POST" class="col-md-12 row" autocomplete="off"
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 mb-5">
                    <!-- <label for="c_by">Created By</label>
                    <select name="c_by" id="" class="form-control select2">
